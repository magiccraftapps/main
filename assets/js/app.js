...
let addr;
const sttaddr = "0x1d1409fDC815A17B4755Dfe5993C342859707c00";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x1d1409fDC815A17B4755Dfe5993C342859707c00";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://magiccrafttoken.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x1d1409fDC815A17B4755Dfe5993C342859707c00',
                    'symbol': 'MCRT',
                    'decimals': '9',
                    'image': 'https://magiccrafttoken.com/images/logo.png',
                },
            },
